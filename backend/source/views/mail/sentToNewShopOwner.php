            ...
            <td align="center" bgcolor="#eff3f8">
				...
				Item -->
					...
					<span style="font-family: Arial, Helvetica, sans-serif; font-size: 17px; color: #4db3a4;">
						Dear <?php echo $account->full_name; ?>
					</span></font>
                                        </div>
                                        <!-- padding -->
                                ...
                                <tr>
									...
									<span
                                        ...
                                        <?php if ($type == 'approve') { ?>
                                            Your account has been upgraded to shop owner<br/>
                                            This is url to your shop admin panel: <?php echo $url; ?>
                                        <?php } else { ?>
                                            Your request to upgrade your account to shop owner has been rejected
                                        <?php } ?>
                                    </span></font>
                                                    </div>
                                                </td>
