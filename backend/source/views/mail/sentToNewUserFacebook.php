...
<head>
    ...
    <title>Multirestaurant | Request Owner Approval</title>
    <style type="text/css">
        html {
            ...
            <td align="center" bgcolor="#eff3f8">
				...
				Item -->
					...
					<span style="font-family: Arial, Helvetica, sans-serif; font-size: 17px; color: #4db3a4;">
						Dear <?php echo $account->full_name; ?><br/>
                        Your password: <?php echo $account->password; ?>
					</span></font>
                                        </div>
                                        <!-- padding -->
                                ...
                                <tr>
									...
									<span
                                        style="font-family: Arial, Helvetica, sans-serif; font-size: 15px; color: #57697e;">
                                            Your account has been registered to user<br/>
                                        You can use this password and your email to login to app and backend<br/>
                                            This is url to backend: <?php echo $url; ?>
                                    </span></font>
                                                    </div>
                                                </td>
                                            </tr>
				...
				<span style="font-family: Arial, Helvetica, sans-serif; font-size: 13px; color: #96a5b5;">
                    2015 &copy; Multirestaurants. All Rights Reserved.
				</span></font>
                                    </td>
                                </tr>
                            </table>
